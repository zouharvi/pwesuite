...
# rsync -azP euler:/cluster/work/sachan/vilem/phonetic-representation/data/multi.tsv data/multi.tsv
...
# rsync -azP euler:/cluster/work/sachan/vilem/phonetic-representation/logs/eval_mismatch_rnn_tokenipa.log computed/mismatch_tokenipa.log
